...
const SCHEMA_SQL = `-- ১. শোনালী দেশ ফুল ডাটাবেজ স্কিমা (Updated)
...
-- ৭. প্রবাসী কর্নার (Exchange Rates)
...
-- ৮. কারিগরি কোর্স (Vocational Courses)
...
-- ১৫. পাইকারি বিজ্ঞাপন (Wholesale Ads)
