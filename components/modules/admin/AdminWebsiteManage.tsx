...
-- রক্তদাতার নম্বর দেখার লগ টেবিল (NEW)
...
do $$ begin
  ...
  create policy "Public Access Donor Logs" on public.donor_view_logs for all using (true) with check (true);
