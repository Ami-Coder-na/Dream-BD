...
const SCHEMA_SQL = `-- ১. ড্রিম বিডি ডাটাবেজ সেটআপ (Full Schema)
...
-- রক্তদাতা নম্বর দেখার লগ (Blood Access Logs)
...
-- যোগাযোগ (Contact Messages) টেবিল
...
-- জব রিকোয়েস্ট টেবিল (Moderation Queue)
...
-- ব্লগ রিকোয়েস্ট টেবিল (Moderation Queue)
...
-- পাইকারি বিজ্ঞাপন রিকোয়েস্ট টেবিল (Moderation Queue)
...
-- সিকিউরিটি পলিসি (RLS) এনাবল করা
alter table public.app_config enable row level security;
alter table public.jobs enable row level security;
alter table public.blogs enable row level security;
alter table public.districts enable row level security;
alter table public.donors enable row level security;
alter table public.donor_view_logs enable row level security;
...
-- পাবলিক এক্সেস পলিসি তৈরি (সবার জন্য রিড/রাইট সুবিধা)
do $$ begin
  ...
  create policy "Public Access" on public.districts for all using (true) with check (true);
  create policy "Public Access" on public.donors for all using (true) with check (true);
  create policy "Public Access" on public.donor_view_logs for all using (true) with check (true);
