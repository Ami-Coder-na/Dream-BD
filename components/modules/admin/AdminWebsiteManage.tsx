...
const SCHEMA_SQL = `-- ১. আগে যদি রিকোয়েস্ট টেবিল থাকে তা ডিলিট করে নতুন করে তৈরি করা (Fresh Start)
drop table if exists public.requests;

create table public.requests (
  id bigint generated by default as identity primary key, 
  created_at timestamp with time zone default timezone('utc'::text, now()) not null,
  contenttype text, -- 'job' or 'blog'
  title text,
  category text,
...
-- ২. সিকিউরিটি পলিসি সেট করা যাতে যেকেউ রিকোয়েস্ট পাঠাতে পারে
alter table public.requests enable row level security;
drop policy if exists "Enable all access" on public.requests;
create policy "Enable all access" on public.requests for all using (true) with check (true);

-- ৩. জবস এবং ব্লগস টেবিল চেক করা
