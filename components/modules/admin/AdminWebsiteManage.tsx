...
const SCHEMA_SQL = `-- ১. নতুন টেবিল তৈরি বা আপডেট করুন (পুনরায় তৈরি করার জন্য DROP ব্যবহার করা হয়েছে)

-- পাইকারি বিজ্ঞাপন রিকোয়েস্ট টেবিল মুছে ফেলা এবং সঠিক কলাম সহ তৈরি করা
drop table if exists public.wholesale_requests;
...
-- পাইকারি বিজ্ঞাপন মেইন টেবিল মুছে ফেলা এবং সঠিক কলাম সহ তৈরি করা
drop table if exists public.wholesale_ads;
create table public.wholesale_ads (
  id bigint generated by default as identity primary key,
  product text,
  quantity text,
  price text,
