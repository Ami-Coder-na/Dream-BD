...
-- 6. OTHERS (Grievances, Wholesale, etc.)
...
-- CRITICAL: REALTIME REPLICATION SETUP
         ...
         <div className="p-6">
            {!isSupabaseConfigured ? (
                ...
                <div className="text-center py-6">
                    ...
                    <p className="text-gray-500 mb-6">Run this SQL code to ensure all tables and columns (especially 'level') exist.</p>
                    ...
                    <div className="bg-gray-900 text-white p-6 rounded-2xl border border-gray-800 text-left">
                        ...
                        <p className="text-sm text-gray-300 mb-4 leading-relaxed">
                            Run this SQL in Supabase Query Editor. It uses <strong>IF NOT EXISTS</strong> to safely add missing columns without deleting data. It also fixes permission issues.
                        </p>
