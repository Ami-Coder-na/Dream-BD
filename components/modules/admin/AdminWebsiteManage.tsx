...
create table if not exists public.craft_products (
  ...
  descriptionen text,
  material text,
  ecofriendly boolean default true,
  created_at timestamp with time zone default timezone('utc'::text, now()) not null
);

-- ১৯. কবি ও সাহিত্যিক টেবিল
...
export const AdminWebsiteManage = () => {
  ...
  const handleFaviconUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      try {
        const compressed = await compressImage(file, 128, 0.6); // Very small for favicon
  ...
  return (
    <div className="space-y-8 animate-fade-in max-w-7xl mx-auto pb-20">
      ...
      {/* ... SQL Configuration blocks unchanged ... */}
    </div>
  );
};
