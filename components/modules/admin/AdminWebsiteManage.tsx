...
const SCHEMA_SQL = `-- ১. কন্টেন্ট ম্যানেজমেন্টের জন্য সব টেবিল তৈরি করুন
...
-- বাজার সদাই (প্রাইস ও প্রোডাক্ট)
create table if not exists public.market_prices (
  id bigint generated by default as identity primary key,
  nameen text, namebn text, unit text, today_price numeric,
  yesterday_price numeric, trend text,
  created_at timestamp with time zone default timezone('utc'::text, now()) not null
);

create table if not exists public.retail_products (
  id bigint generated by default as identity primary key,
  nameen text, namebn text, price numeric, unit text,
  category text, image text, stock text default 'Available'
);
