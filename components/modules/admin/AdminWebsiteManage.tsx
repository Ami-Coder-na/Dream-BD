...
do $$ begin
  ...
  create policy "Public Access Donors" on public.donors for all using (true) with check (true);
  create policy "Public Access Logs" on public.donor_view_logs for all using (true) with check (true);
